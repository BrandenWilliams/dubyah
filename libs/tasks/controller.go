...
func (c *Controller) UpdateTaskText(ctx context.Context, entryID string, e Entry) (updated *Entry, err error) {
	err = c.m.Transaction(ctx, func(txn *mojura.Transaction[Entry, *Entry]) (err error) {
		updated, err = c.updateTaskText(txn, entryID, &e)
		return
	})
...
func (c *Controller) Delete(ctx context.Context, userID string) (removed *Entry, err error) {
	err = c.m.Transaction(ctx, func(txn *mojura.Transaction[Entry, *Entry]) (err error) {
...
func (c *Controller) updateTaskText(txn *mojura.Transaction[Entry, *Entry], entryID string, e *Entry) (updated *Entry, err error) {
	updated, err = c.update(txn, entryID, func(orig *Entry) (err error) {
		orig.TaskText = e.TaskText
